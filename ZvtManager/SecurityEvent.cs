...
{
    public class SecurityEvent : BaseEvent, IBaseSecurityModuleEvent
    {
        #region Public Fields

        public static Guid EventGuid = new Guid("{2827F9C8-8D3C-11D3-8F36-0080AD38DE23}");

        #endregion Public Fields

        #region Public Constructors

        public SecurityEvent(string terminalOid) : base(terminalOid)
        {
        }
